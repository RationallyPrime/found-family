...
class QueryHelpers:
    ...
    def match_memory(self: "CypherQueryBuilder", alias: str = "m", **properties: Any) -> "CypherQueryBuilder":
    ...
    def match_conversation(
        self: "CypherQueryBuilder", conversation_id: UUID, memory_alias: str = "m", conv_alias: str = "c"
    ) -> "CypherQueryBuilder":
        ...
        Returns:
            Self for method chaining
        """
        return self.match(lambda p: p.node("Conversation", conv_alias, id=str(conversation_id))).match(
            lambda p: p.node(conv_alias).rel_to("HAS_MEMORY").node("Memory", memory_alias)
        )

    def match_topic_memories(
        self: "CypherQueryBuilder", topic_id: int, memory_alias: str = "m", topic_alias: str = "t"
    ) -> "CypherQueryBuilder":
        ...
        Returns:
            Self for method chaining
        """
        return self.match(lambda p: p.node("Topic", topic_alias, id=topic_id)).match(
            lambda p: p.node(topic_alias).rel_to("CONTAINS").node("Memory", memory_alias)
        )
    ...
    def filter_similarity(
        self: "CypherQueryBuilder", threshold: float = 0.7, similarity_alias: str = "similarity"
    ) -> "CypherQueryBuilder":
    ...
    def expand_relationships(
        ...
        return match_func(lambda p: p.node(from_alias).rel(rel_pattern).node("Memory", to_alias))
    ...
    def collect_relationships(
        ...
        Returns:
            Self for method chaining
        """
        return self.with_clause(node_alias, f"COLLECT(DISTINCT {related_alias}) AS {collection_name}")

    def paginate(self: "CypherQueryBuilder", page: int = 1, page_size: int = 20) -> "CypherQueryBuilder":
    ...
    def count(self: "CypherQueryBuilder", alias: str = "m", distinct: bool = True) -> "CypherQueryBuilder":
    ...
    def exists(self: "CypherQueryBuilder", alias: str = "m") -> "CypherQueryBuilder":
    ...
    def aggregate(
        self: "CypherQueryBuilder", alias: str = "m", aggregations: dict[str, str] | None = None
    ) -> "CypherQueryBuilder":
    ...
    def with_access_tracking(self: "CypherQueryBuilder", alias: str = "m") -> "CypherQueryBuilder":
        ...
        return self.set_property(
            alias, {"last_accessed": "datetime()", "access_count": f"COALESCE({alias}.access_count, 0) + 1"}
        )
